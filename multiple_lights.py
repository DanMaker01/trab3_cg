...
def main() -> int:
    ...
    while (not glfwWindowShouldClose(window)):
        ...
        # directional light
        lightingShader.setVec3("dirLight.direction", 0, 0, 0)
        lightingShader.setVec3("dirLight.ambient", 0.05, 0.05, 0.05)
        lightingShader.setVec3("dirLight.diffuse", 0.0, 0.0, 0.0)
        lightingShader.setVec3("dirLight.specular", 0.0, 0.0, 0.0)
        # point light 1
        lightingShader.setVec3("pointLights[0].position", pointLightPositions[0]+glm.vec3(a, 0.0, 0.0))
        ...
        # point light 2
        lightingShader.setVec3("pointLights[1].position", pointLightPositions[1]+glm.vec3(0.0, a, 0.0))
        ...
        # point light 3
        lightingShader.setVec3("pointLights[2].position", pointLightPositions[2]+glm.vec3(0.0, 0.0, a))
        ...
        # point light 4
        lightingShader.setVec3("pointLights[3].position", pointLightPositions[3]+glm.vec3(a, 0.0, 0.0))
        ...
        for i in range(3):
         ...
         model = glm.translate(model, pointLightPositions[i]+ glm.vec3(a, 0.0, 0.0))
